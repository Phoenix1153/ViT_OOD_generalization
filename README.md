...
**Illustration of our taxonomy of distribution shifts.** We build the taxonomy upon what kinds of semantic concepts are modified from the original image and divide the distribution shifts into four cases: background shifts, corruption shifts, texture shifts, and style shifts. $\color{red} √$ denotes the unmodified vision cues under certain type of distribution shifts. Please refer to the literature for details.
